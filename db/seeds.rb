...
Topic.create!(title: "Weather")
Topic.create!(title: "Sport")
Topic.create!(title: "Culture")
Topic.create!(title: "Finance")
Topic.create!(title: "Travelling")
Topic.create!(title: "Real Estate")
Topic.create!(title: "Tech")
Topic.create!(title: "Pets")
puts "Topic seeded"
#News
Subtopic.create!(title: "World", topic_id: 1)
Subtopic.create!(title: "Regional", topic_id: 1)
Subtopic.create!(title: "Local", topic_id: 1)
Subtopic.create!(title: "Environental", topic_id: 1)
Subtopic.create!(title: "Politics", topic_id: 1)
#Sport
Subtopic.create!(title: "Football", topic_id: 3)
Subtopic.create!(title: "Rugby", topic_id: 3)
Subtopic.create!(title: "Tennis", topic_id: 3)
Subtopic.create!(title: "Golf", topic_id: 3)
Subtopic.create!(title: "Basketball", topic_id: 3)
Subtopic.create!(title: "Mountain Unicycling", topic_id: 3)
Subtopic.create!(title: "Diving", topic_id: 3)
Subtopic.create!(title: "American Football", topic_id: 3)
Subtopic.create!(title: "Ice Hockey", topic_id: 3)
Subtopic.create!(title: "BMX", topic_id: 3)
#Culture
Subtopic.create!(title: "Art", topic_id: 4)
Subtopic.create!(title: "Architecture", topic_id: 4)
Subtopic.create!(title: "History", topic_id: 4)
Subtopic.create!(title: "Design", topic_id: 4)
Subtopic.create!(title: "Theatre", topic_id: 4)
Subtopic.create!(title: "Movies", topic_id: 4)
Subtopic.create!(title: "Literature", topic_id: 4)
Subtopic.create!(title: "Events", topic_id: 4)
#Finance
Subtopic.create!(title: "Investing", topic_id: 5)
Subtopic.create!(title: "Cryptos", topic_id: 5)
Subtopic.create!(title: "Mortgages", topic_id: 5)
#TRAVELLING = ["Hotels", "Flights", "Deals", "Events"]
Subtopic.create!(title: "Hotels", topic_id: 6)
Subtopic.create!(title: "Flights", topic_id: 6)
Subtopic.create!(title: "Deals", topic_id: 6)
Subtopic.create!(title: "Events", topic_id: 6)
Subtopic.create!(title: "Destinations", topic_id: 6)
#REALESTATE = ["Rental Market", "Buying Market", "Development"]
Subtopic.create!(title: "Rental Market", topic_id: 7)
Subtopic.create!(title: "Buying Market", topic_id: 7)
Subtopic.create!(title: "Development", topic_id: 7)
#TECH = ["Coding", "Gadgets", "Silicon Valley", "Future"]
Subtopic.create!(title: "Coding", topic_id: 8)
Subtopic.create!(title: "Gadgets", topic_id: 8)
Subtopic.create!(title: "Silicon Valley", topic_id: 8)
Subtopic.create!(title: "Future", topic_id: 8)
#PETS = ["Dogs", "Cats", "Birds", "Elephants"]
Subtopic.create!(title: "Dogs", topic_id: 9)
Subtopic.create!(title: "Cats", topic_id: 9)
Subtopic.create!(title: "Birds", topic_id: 9)
Subtopic.create!(title: "Elephants", topic_id: 9)
